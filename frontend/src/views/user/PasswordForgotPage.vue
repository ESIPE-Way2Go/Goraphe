<template>
  <div class="d-flex align-center fill-height bg-image">
    <v-card class="mx-auto pa-6 bg-white rounded-xl outline" height="65%" style="border-color: blue" variant="outlined"
            width="40%">
      <v-img :src=imageGoraphe class="mx-auto" cover width="40%"></v-img>
      ...
      <v-card-text>
        <v-form v-model="isFormValid" fast-fail @submit.prevent="sendForgotPassword">
          ...
          <v-btn :disabled="!isFormValid" class="mt-2 rounded-3 mx-auto d-table bg-blue-darken-1" type="submit">
            Envoyer
          </v-btn>
        </v-form>
      </v-card-text>
